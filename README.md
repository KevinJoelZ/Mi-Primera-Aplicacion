...
![Pantalla principal](https://via.placeholder.com/600x300?text=Pantalla+Principal)  
*Imagen de la pantalla principal de la aplicación.*
...
![Uso de colores](https://via.placeholder.com/600x300?text=Colores+de+Interfaz)  
*Ejemplo de la paleta de colores utilizada.*
...
![Pantallas de navegación](https://via.placeholder.com/600x300?text=Navegación+Entre+Pantallas)  
*Visualización de las transiciones entre pantallas.*
...
![UX en acción](https://via.placeholder.com/600x300?text=UX+en+Acción)  
*Flujo de usuario sencillo y rápido.*
...
![Accesibilidad](https://via.placeholder.com/600x300?text=Accesibilidad)  
*Detalles sobre las características de accesibilidad.*
